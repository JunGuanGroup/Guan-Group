...
2. 具备以下技能至少一项或能快速学习相关技能：纳米光学结构设计与仿真、光路搭建与光学测量、可见光/近红外激光实验、微纳加工与表征、机器学习工具使用经验（Pytorch/JAX）。
...
3. 将优先考虑具备以下条件的申请者：
    ...
    * 具有光路搭建及激光实验经验、微纳结构加工及表征经验、Pytorch/JAX使用经验、或高水平学术论文写作经验
    * 编程能力强
